...
FAST5_DIR=/home/generico/oh-dev/cw_onehealth_protocols/local/seq100621/fast5
SEQSUM=/home/generico/oh-dev/cw_onehealth_protocols/local/seq100621/guppy/sequencing_summary.txt
FASTQS=/home/generico/oh-dev/cw_onehealth_protocols/local/seq100621/barcode
filename="/home/generico/oh-dev/cw_onehealth_protocols/local/seq100621/barcodes.txt"
while read -r line; do
	...
	mkdir /home/generico/oh-dev/cw_onehealth_protocols/local/seq100621/res_${barcode}
	cd /home/generico/oh-dev/cw_onehealth_protocols/local/seq100621/res_${barcode}
